...
| Never public | protected assessment materials, protected review records, badge decision records, private process details, private storage details |
...
QF-101 starts with QF-101.0: Environment Readiness and Simulation Setup. The public site shows only the overview; approved learners receive the released unit through the enrolled learner process.
...
Assessed work is handled through the enrolled learner process. Learners must not publish assignments, tests, protected responses, private review feedback, badge decision records, or protected course materials in public issues, pull requests, websites, repositories, or social posts.
