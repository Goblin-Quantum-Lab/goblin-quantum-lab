...
Do not include passwords, API keys, access tokens, secrets, private account details, official solutions, protected assessment materials, enrolled-only instructions, or reviewer notes.
